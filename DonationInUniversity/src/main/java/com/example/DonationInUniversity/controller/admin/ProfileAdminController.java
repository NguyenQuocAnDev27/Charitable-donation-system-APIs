...
public class ProfileAdminController {
    ...
    public String profile(Model model) {
        ...
        return "ProjectManager/pm_profile"; // Trả về trang Thymeleaf
    }
    ...
    public String saveOrUpdateProfile(UserBankInfo profile) {
        ...
        if (existingProfile != null) {
            ...
            existingProfile.setIsDeleted(profile.getIsDeleted()); // Hoặc bất kỳ thông tin nào cần cập nhật
            ...
            profile.setIsDeleted(1); // Đặt giá trị isDeleted tùy theo logic
